    ...
    <div className="lightbox-overlay">
      ...
      <div className="lightbox-actions">
        ...
        <div className="letterhead">
          ...
          <p>As you’re aware, the public holiday substitution clause of our workplace agreement allows employees to swap public holidays for others dates of personal or national significance.</p>
