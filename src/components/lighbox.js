    ...
    <div className="lightbox-overlay">
      ...
      <div className="lightbox-actions">
        ...
        <div className="letterhead">
          ...
          <p>As you may know, in many workplace agreement contracts there is a public holiday substitution clause that permits employees to request a swap of public holidays for dates of personal or cultural importance, subject to employer approval.</p>
